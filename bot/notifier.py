...
def format_signal_message(signal: dict) -> str:
    ...
    lines = [
        ...
        f"احتمال موفقیت (AI): {signal['ai_probability']['probability_pct']}%",
...
def broadcast_news_text(text: str):
    """برای بخش ۱۱: ارسال متن تحلیل/خبر به کانال (بدون فرمت سیگنال)"""
    send_telegram_message(text, channel_id=TELEGRAM_NEWS_CHANNEL_ID)
